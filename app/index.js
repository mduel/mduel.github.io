...
function createBackground(div_holder)
{
    ...
    {
        v.background_image  = DATA_Image.getImage("game_background");
    }
    ...
    SYS_UI.create([
        {
            ...
            style:{
                ...
                alignItems:"center",
                background:"transparent",
                backgroundImage:`url( ${ DATA_Image.getImage("game_background") })`,
                backgroundSize:  v.holder_width.toString() + "px" + " " +  v.holder_height.toString() + "px"
            }
        },
        {
            ...
            style:{
                ...
                background:"transparent",
                backgroundImage:`url( ${ DATA_Image.getImage("text_connection_failed") })`,
        ...
        },
        {
            ...
            style:{
                ...
                border: "0px",
                background:"transparent",
                backgroundImage:`url( ${ DATA_Image.getImage("button_continue") })`,
    ...
    SYS_UI.create([
        {
            ...
            style:{
                ...
                border: "0px",
                background:"transparent",
                backgroundImage:`url( ${ DATA_Image.getImage("button_back") } )`,
        ...
        },
        {
            ...
            style:{
                ...
                border: "0px",
                background:"transparent",
                backgroundImage:`url( ${ DATA_Image.getImage("button_settings") } )`,
...
f.initialize = function(div_holder)
{
    ...
    //Create Loadout
    ARENA_Prep_Loadout_Character.interface("arena_prep_loadout_div_character");
    ARENA_Prep_Loadout_Blessing.interface("arena_prep_loadout_div_blessing");
    ARENA_Prep_Loadout_Spells.interface(v.row_count,v.column_count,v.size,"arena_prep_loadout_div_bottom");
...
function createMeasurement(div_holder)
{
    ...
    else if(SYS_Data.game.orientation === "landscape")
    {
        ...
        if(ratio <= 2.5)
        {
            v.size = (v.holder_width / 3) * 0.50
            v.w = v.size * 3;
            v.h = v.size * 2;
            v.row_count = 3;
            v.column_count = 2; 
        }else if(ratio > 2.5 && ratio <= 3.6)
        {
            v.size = (v.holder_width / 3) * 0.40
            v.w = v.size * 3;
            v.h = v.size * 2;
            v.row_count = 3;
            v.column_count = 2;
    ...
    v.arena_prep_loadout_div_top = { width: v.size * 2.5, height: v.size * 1.25, margin: v.m };
    v.arena_prep_loadout_div_content = { width: v.size * 1.25, height: v.size * 1.25 };
    v.arena_prep_loadout_div_bottom = { width: v.w, height: v.h };
    ...
    SYS_UI.create([
        {
            ...
            attach:div_holder,
            style:{
                width: v.arena_prep_loadout_div_top.width.toString() + "px",
                height: v.arena_prep_loadout_div_top.height.toString() + "px",
                margin: v.arena_prep_loadout_div_top.margin.toString() + "px",
                display:"flex",
                flexDirection:"row",
                justifyContent:"center",
                alignItems:"center",
        ...
        {
            type:"div", 
            id:"arena_prep_loadout_div_character", 
            attach:"arena_prep_loadout_div_top",
            style:{
                width: v.arena_prep_loadout_div_content.width.toString() + "px",
                height: v.arena_prep_loadout_div_content.height.toString() + "px",
                display:"flex",
                flexDirection:"column",
                justifyContent:"center",
                alignItems:"center",
        ...
        {
            type:"div", 
            id:"arena_prep_loadout_div_blessing", 
            attach:"arena_prep_loadout_div_top",
            style:{
                width: v.arena_prep_loadout_div_content.width.toString() + "px",
                height: v.arena_prep_loadout_div_content.height.toString() + "px",
        ...
        },
        {
            ...
            attach:div_holder,
            style:{
                width: v.arena_prep_loadout_div_bottom.width.toString() + "px",
                height: v.arena_prep_loadout_div_bottom.height.toString() + "px",
                display:"flex",
                flexDirection:"row",
                justifyContent:"center",
                alignItems:"center",
    ...
    SYS_UI.create([
        {
            ...
            style:{
                ...
                border: "0px",
                background:"transparent",
                backgroundImage:`url( ${ DATA_Image.getImage("button_offline") } )`,
        ...
        },
        {
            ...
            style:{
                ...
                border: "0px",
                background:"transparent",
                backgroundImage:`url( ${ DATA_Image.getImage("button_online") } )`,
...
return f;}());var ARENA_Prep_Loadout_Blessing = (function(){var f ={};
...
{  
    ...
    v.image = {width: v.holder_width * 0.70, height: v.holder_height * 0.50};
    v.button = {width: v.holder_width * 0.60, height: v.holder_height * 0.25};
    v.marginTop = v.holder_height * 0.05;

    SYS_UI.create([
        {
            type:"img",
            id: "arena_prep_loadout_blessing_image",
            attach: div_holder,
            attrib:{
                src:DATA_Image.getImage("default"),
                onclick:"",
            ...
            style:{
                width:v.image.width.toString() + "px",
                height:v.image.height.toString() + "px",
            }
        },
        {
            type:"button",
            id: "arena_prep_loadout_blessing_button",
            attach: div_holder,
            attrib:{
                onclick:"ARENA_Prep_Select.initialize('blessing');",
                ontouch:"ARENA_Prep_Select.initialize('blessing');"
            },
            style:{
                width:v.button.width.toString() + "px",
                height:v.button.height.toString() + "px",
                marginTop:v.marginTop.toString() + "px",
                border: "0px",
                background:"transparent",
                backgroundImage:`url( ${ DATA_Image.getImage("button_edit") } )`,
                backgroundSize:  v.button.width.toString() + "px" + " " +   v.button.height.toString() + "px"
...
{  
    ...
    SYS_UI.create([
        ...
        {
            type:"button",
            id: "arena_prep_loadout_character_button",
            attach: div_holder,
            attrib:{
                onclick:"ARENA_Prep_Select.initialize('character');",
                ontouch:"ARENA_Prep_Select.initialize('character');"
            },
            style:{
                width:v.button.width.toString() + "px",
                height:v.button.height.toString() + "px",
...
f.interface = function(row,column,size,div_holder)
{  
    var v = {};
    ...
    v.spells_count = 0;
    v.spell_div_size = size;
    v.spell_image_size = size * 0.50;
    v.spell_button = {width: size * 0.60, height: size * 0.25, marginTop: size * 0.05}
    ...
    for(var r = 1; r <= v.row_count;r++)
    {
        ...
        for(var c = 1; c <= v.column_count;c++)
        {
            ...
            SYS_UI.create([
                ...
                {
                    type:"div",
                    id: "arena_prep_loadout_spell_div"+v.spells_count,
                    ...
                    style:{
                        ...
                        justifyContent:"center",
                        alignItems:"center",
                        width:v.spell_div_size.toString() + "px",
                        height:v.spell_div_size.toString() + "px",
                    }
                },
                {
                    type:"img",
                    id: "arena_prep_loadout_spell_image"+v.spells_count,
                    attach: "arena_prep_loadout_spell_div"+v.spells_count,
                    attrib:{
                        src:DATA_Image.getImage("default"),
                        onclick:"",
                        ontouch:""
                ...
                {
                    type:"button",
                    id: "arena_prep_loadout_spell_button"+v.spells_count,
                    attach: "arena_prep_loadout_spell_div"+v.spells_count,
                    attrib:{
                        onclick:"ARENA_Prep_Select.initialize('spells');",
                        ontouch:"ARENA_Prep_Select.initialize('spells');"
                    },
                    style:{
                        width:v.spell_button.width.toString() + "px",
                        height:v.spell_button.height.toString() + "px",
                        marginTop:v.spell_button.marginTop.toString() + "px",
                        border: "0px",
                        background:"transparent",
                        backgroundImage:`url( ${ DATA_Image.getImage("button_edit") } )`,
                        backgroundSize:  v.spell_button.width.toString() + "px" + " " +   v.spell_button.height.toString() + "px"
...
return f;}());var ARENA_Prep_Select = (function(){var f ={};

f.initialize = function(mode)
{
    //Clear the interface first before adding anything
    SYS_UI.clear({id:SYS_UI.body});
    ...
    //Create the spells
    createTitle("arena_prep_select_div_layer0",mode);
    createList("arena_prep_select_div_layer1",mode);
    createCancel("arena_prep_select_div_layer2");
...
function createLayout(div_holder)
{
    ...
    v.t = 0;
    v.arena_prep_select_div_layer0 = { width: v.holder_width, height: v.h1, top: v.t };

    v.t = v.h1;
    v.arena_prep_select_div_layer1 = { width: v.holder_width, height: v.h2, top: v.t };

    v.t = v.h1 + v.h2;
    v.arena_prep_select_div_layer2 = { width: v.holder_width, height: v.h3, top: v.t };
    ...
    SYS_UI.create([
        ...
        {
            type:"div", 
            id:"arena_prep_select_div_layer0", 
            attach:"arena_prep_select_div_main",
            style:{
                width: v.arena_prep_select_div_layer0.width.toString() + "px",
                height: v.arena_prep_select_div_layer0.height.toString() + "px",
                position:"absolute",
                top:v.arena_prep_select_div_layer0.top.toString() + "px",
                left:"0px",
                display:"flex",
                flexDirection:"row",
                justifyContent:"center",
        ...
        {
            type:"div", 
            id:"arena_prep_select_div_layer1", 
            attach:"arena_prep_select_div_main",
            style:{
                width: v.arena_prep_select_div_layer1.width.toString() + "px",
                height: v.arena_prep_select_div_layer1.height.toString() + "px",
                position:"absolute",
                top:v.arena_prep_select_div_layer1.top.toString() + "px",
                left:"0px",
                display:"flex",
                flexDirection:"row",
                justifyContent:"center",
        ...
        {
            type:"div", 
            id:"arena_prep_select_div_layer2", 
            attach:"arena_prep_select_div_main",
            style:{
                width: v.arena_prep_select_div_layer2.width.toString() + "px",
                height: v.arena_prep_select_div_layer2.height.toString() + "px",
                position:"absolute",
                top:v.arena_prep_select_div_layer2.top.toString() + "px",
                left:"0px",
                display:"flex",
                flexDirection:"row",
                justifyContent:"center",
...
function createTitle(div_holder,mode)
{
    var v = {}; var w = 0; var h = 0;
    ...
    v.arena_prep_select_title = { width: w, height: h };

    if(mode === "spells") { v.title = "text_choose_a_spell"; }
    else if(mode === "blessing"){ v.title = "text_choose_a_blessing"; }
    else if(mode === "character"){ v.title = "text_choose_a_character"; };

    SYS_UI.create([
        {
            type:"div", 
            id:"arena_prep_select_title", 
            attach:div_holder,
            style:{
                width: v.arena_prep_select_title.width.toString() + "px",
                height: v.arena_prep_select_title.height.toString() + "px",
                background:"transparent",
                backgroundImage:`url( ${ DATA_Image.getImage(v.title) })`,
                backgroundSize: v.arena_prep_select_title.width.toString() + "px" + " " +  v.arena_prep_select_title.height.toString() + "px"
            }
        },
    ]);
};

function createCancel(div_holder)
{
    var v = {}; var w = 0; var h = 0;
    ...
    v.arena_prep_select_cancel = { width: w, height: h };
    
    SYS_UI.create([
        {
            type:"button", 
            id:"arena_prep_select_cancel", 
            attach:div_holder,
            style:{
                width: v.arena_prep_select_cancel.width.toString() + "px",
                height: v.arena_prep_select_cancel.height.toString() + "px",
                border: "0px",
                background:"transparent",
                backgroundImage:`url( ${ DATA_Image.getImage("button_cancel") })`,
                backgroundSize:  v.arena_prep_select_cancel.width.toString() + "px" + " " +  v.arena_prep_select_cancel.height.toString() + "px"
            },
            attrib:
            { 
...
function createList(div_holder,mode)
{
    var v = {};
    ...
    if(SYS_Data.game.orientation === "portrait")
    {  
        if(ratio <= 0.6){ v.column_count = 2; }
        else if(ratio > 0.6 && ratio <= 0.8){ v.column_count = 3; }
        else if(ratio > 0.8){ v.column_count = 4; }
    }
    else if(SYS_Data.game.orientation === "landscape")
    {
        if(ratio <= 2.5){ v.column_count = 5; }
        else if(ratio > 2.5 && ratio <= 3.6){ v.column_count = 4; }
        else if(ratio > 3.6){ v.column_count = 4; }
    };
    ...
    v.list_image_size = v.size * 0.50;
    v.list_button = { width: v.size * 0.60, height: v.size * 0.20, marginTop: v.size * 0.05 }

    SYS_UI.create([
        {
            type:"table", 
            id:"arena_prep_select_table", 
            attach:div_holder,
            style:
            {
                position:"absolute",
    ...
    for(var r = 1; r <= v.row_count;r++)
    {
        SYS_UI.create([
            {
                type:"tr", 
                id:"arena_prep_select_table_tr"+r,
                attach:"arena_prep_select_table"
            }
        ]);  
        ...
        for(var c = 1; c <= v.column_count;c++)
        {
            ...
            SYS_UI.create([
                {
                    type:"td", 
                    id:"arena_prep_select_table_tr"+r+"td"+c,
                    attach:"arena_prep_select_table_tr"+r,
                },
                {
                    type:"div",
                    id: "arena_prep_select_list_div"+v.list_count,
                    attach:"arena_prep_select_table_tr"+r+"td"+c,
                    style:{
                        display:"flex",
                        flexDirection:"column",
                        justifyContent:"center",
                ...
                {
                    type:"img",
                    id: "arena_prep_select_list_image"+v.list_count,
                    attach: "arena_prep_select_list_div"+v.list_count,
                    attrib:{
                        src:DATA_Image.getImage("default"),
                        onclick:"",
                        ontouch:""
                ...
                {
                    type:"button",
                    id: "arena_prep_select_list_button"+v.list_count,
                    attach: "arena_prep_select_list_div"+v.list_count,
                    attrib:{
                        onclick:"",
                        ontouch:""
                    ...
                    style:{
                        width:v.list_button.width.toString() + "px",
                        height:v.list_button.height.toString() + "px",
                        marginTop:v.list_button.marginTop.toString() + "px",
                        border: "0px",
                        background:"transparent",
                        backgroundImage:`url( ${ DATA_Image.getImage("button_edit") } )`,
                        backgroundSize:  v.list_button.width.toString() + "px" + " " +   v.list_button.height.toString() + "px"
...
f.initialize = function(result_data,user_data)
{
    ...
    if(typeof(result_data) !== "string")
    {
        ...
        SYS_UI.style([
            {
                id:"result_image",
                backgroundImage:`url( ${ DATA_Image.getImage(combat_result) })`
            }
        ])
    ...
    else if(typeof(result_data) === "string")
    {
        SYS_UI.style([
            {
                id:"result_image",
                backgroundImage:`url( ${ DATA_Image.getImage("text_error_occured") })`
            }
        ])
    };
    ...
    SYS_UI.create([
        ...
        },
        {
            ...
            style:{
                ...
                height: v.image_height.toString() + "px",
                background:"transparent",
                backgroundImage:`url( ${ DATA_Image.getImage("default_image") })`,
                backgroundSize:  v.image_width.toString() + "px" + " " +  v.image_height.toString() + "px"
            }
        },
        {
...
var blessing_data = 
{
    ...
    "bl01":
    {
        image:"././media/images/icons/blessings/GreaterBlessingofSalvation.png",
        spell_list: ["sp01","sp02","sp03","sp04"] //Max 18 spells. sp00 means none so dont include it
    },

    "bl02":
    {
        image:"././media/images/icons/blessings/GreaterBlessingofSanctuary.png",
        spell_list: ["sp01","sp02","sp03","sp04"] //Max 18 spells. sp00 means none so dont include it
    },

    "bl03":
    {
        image:"././media/images/icons/blessings/GreaterBlessingofWisdom.png",
        spell_list: ["sp01","sp02","sp03","sp04"] //Max 18 spells. sp00 means none so dont include it
    },
};
...
{   
    ...
    switch(name)
    {
        ...
        case "button_back":
            link =  "././media/images/ui/button_back.png";
        break;

        case "button_settings":
            link =  "././media/images/ui/button_settings.png";
        break;

        case "button_edit":
            link =  "././media/images/ui/button_edit.png";
        break;

        case "button_select":
            link =  "././media/images/ui/button_select.png";
        break;
        
        case "text_choose_a_character":
            link =  "././media/images/ui/text_choose_a_character.png";
        break;

        case "text_choose_a_spell":
            link =  "././media/images/ui/text_choose_a_spell.png";
        break;

        case "text_choose_a_blessing":
            link =  "././media/images/ui/text_choose_a_blessing.png";
        break;
        ...
        case "text_error_occured":
            link =  "././media/images/ui/text_error_occured.png";
        break;
    ...
    SYS_UI.create([
        ...
        },
        {
            ...
            style:{
                ...
                border: "0px",
                background:"transparent",
                backgroundImage:`url( ${ DATA_Image.getImage("button_arena") } )`,
                backgroundSize:  v.button_width.toString() + "px" + " " +  v.button_height.toString() + "px"
            },
            attrib:
            { 
...
f.genericUpdate = function(entity,battledata)
{   
    if(battledata.private.core.time % 5 === 0)
    {
        entity.combat.duration++;
...
function startCurrentGameInterface()
{
    ...
    switch(SYS_Data.game.current_interface)
    {
        ...
        case "arena_result":
            //Since arena result requires result and user data
            //then we need to go to preparation since we lost
            //it once we restart the app
            ARENA_Preparation.initialize();
        break;
    ...
    SYS_UI.create([
        ...
        },
        {
            ...
            style:{
                ...
                height: v.image_height.toString() + "px",
                background:"transparent",
                backgroundImage:`url( ${ DATA_Image.getImage("text_connecting") })`,
                backgroundSize:  v.image_width.toString() + "px" + " " +  v.image_height.toString() + "px"
            }
        },
    ]);
